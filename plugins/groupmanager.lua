...
if matches[1] == "add virus" or matches[1] == "تفعيل" then
return modadd(msg)
end
if matches[1] == "rem virus" or matches[1] == "تعطيل" then
return modrem(msg)
end
...
if matches[1] == "setlang" or matches[1] == "عرض الغات" and is_owner(msg) then
...
if not lang then
text = [[
✅¦ اوامر سورس فايروس بل لغه العربيه
...
🔰➖➖🔰➖➖🔰➖➖🔰
✅¦ مطور الـسـورس : @DevAmeer
‎✅¦ قناه الـسـورس : @virus29
]]
end
return text
end
